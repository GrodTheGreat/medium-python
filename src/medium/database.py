...
class User(SQLModel, table=True):
    ...
    sessions: list["UserSession"] = Relationship(back_populates="sessions")
...
with Session(engine) as session:
    post = Article(
        ...
        html_content="""<h1>Medium (website)</h1><p><b>Medium</b> is an American <a href="/wiki/Electronic_publishing" title="Electronic publishing">online publishing platform</a> for written content such as articles and blogs, developed by <a href="/wiki/Evan_Williams_(Internet_entrepreneur)" title="Evan Williams (Internet entrepreneur)">Evan Williams</a> and launched in August 2012. It is owned by <b>A Medium Corporation</b>.<sup id="cite_ref-2" class="reference"><a href="#cite_note-2"><span class="cite-bracket">[</span>2<span class="cite-bracket">]</span></a></sup> The platform is an example of <a href="/wiki/Social_journalism" title="Social journalism">social journalism</a>, having a hybrid collection of amateur and professional people and publications, or exclusive blogs or publishers on Medium,<sup id="cite_ref-3" class="reference"><a href="#cite_note-3"><span class="cite-bracket">[</span>3<span class="cite-bracket">]</span></a></sup> and is regularly regarded as a <a href="/wiki/Blog" title="Blog">blog host</a>.</p><p>Williams, who previously co-founded <a href="/wiki/Blogger_(service)" title="Blogger (service)">Blogger</a> and <a href="/wiki/Twitter" class="mw-redirect" title="Twitter">Twitter</a>,<sup id="cite_ref-4" class="reference"><a href="#cite_note-4"><span class="cite-bracket">[</span>4<span class="cite-bracket">]</span></a></sup> initially developed Medium as a means to publish writings and documents longer than Twitter's then 140-character maximum.</p><p>In March 2021, Medium announced a change in its publishing strategy and business model, reducing its own publications and increasing support of independent writers.<sup id="cite_ref-nytmarch2021_5-0" class="reference"><a href="#cite_note-nytmarch2021-5"><span class="cite-bracket">[</span>5<span class="cite-bracket">]</span></a></sup></p>""",
    )
    session.add(post)
    session.commit()
